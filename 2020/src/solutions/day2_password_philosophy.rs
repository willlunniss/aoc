...
impl FromStr for PasswordPolicy {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        return Ok(PasswordPolicy {
            ...
            policy_char: policy_char.chars().nth(0).unwrap(),
...
#[aoc_generator(day2)]
pub fn gen(input: &str) -> Vec<PasswordPolicy> {
    input.lines().map(|x| x.parse().unwrap()).collect()
}

#[aoc(day2, part1)]
fn part1(input: &Vec<PasswordPolicy>) -> usize {
...
#[aoc(day2, part2)]
fn part2(input: &Vec<PasswordPolicy>) -> usize {
    // Check each entry for validity and count the number that are valid
    /*
